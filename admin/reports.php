...
<body>
	<div id="header">
		<div>
			...
			<ul id="menus">
				...
				<li class="current"><a href="ngo_activities.php">Management</a></li>
	...
	<div id="body">
		<div class="ngo_activities">
			<div>
				<a style="width:auto;padding:30px 50px" id="top_five_report" href="top_five_donor.php">Top Five Donor</a>
				<a id="donation_report" style="width:auto;padding:30px 60px" href="donation_report.php">Donations</a>
				<?php
