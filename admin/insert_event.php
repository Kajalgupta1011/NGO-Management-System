<?php
	...
	$sql = "INSERT INTO event(`event_id`, `event_name`, `event_description`, `date`, `time`, `address`, `city_id`, `duration`, `image`) 
	VALUES('".$id."','".$name."','".$description."','".$date."','".$time."','".$address."',".$city.",'".$duration."','".$img."')";
